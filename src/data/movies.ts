...
export const movies: Movie[] = [
  {
    ...
    description: 'It\'s Harry\'s third year at Hogwarts; ' +
      'not only does he have a new Defense Against the Dark ' +
      'Arts teacher, but there is also trouble brewing. Convicted ' +
      'murderer Sirius Black has escaped the Wizards\' Prison and is ' +
      'coming after Harry.',
    nsfw: false,
    like: false
  },
  ...
  },
  {
    ...
    description: 'Dystopian future where humanity is struggling to' +
